...
4. After installing> open Eclipse>Help>Install New Software. Use [this](http://download.eclipse.org/tracecompass/releases/9.0.0/repository/) link for the following repo for tracecompass: 
